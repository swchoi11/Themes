...
if __name__ == "__main__":
    ...
    filepath = f'./output/excels/all_issues/result-{datetime.strftime("%Y%m%d")}.xlsx'
    output_file = f'./output/report-{datetime.strftime("%Y%m%d")}.csv'
    ...
    report.to_excel(f'./output/issue_report-{datetime.strftime("%Y%m%d")}.xlsx')